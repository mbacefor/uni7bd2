...
var fs = require('fs');
var data = fs.readFileSync('C:\\git\\github\\uni7bd2\\202102\\database.json', 'utf8');
...
function write(chave, valor) {
    ...
    fs.writeFile('C:\\git\\github\\uni7bd2\\202102\\database.json', JSON.stringify(jsonBD), function (err) {
        if (err) throw err;
        console.log('Saved!');
    });
}
